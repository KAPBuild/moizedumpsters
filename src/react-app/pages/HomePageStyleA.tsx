...
export const HomePageStyleA = () => {
  ...
  const services = [
    { title: 'Residential', img: '/images/residential-dumpsters.jpg', desc: 'Home cleanouts, renovations, and landscaping projects. Reliable service for homeowners.' },
    { title: 'Construction', img: '/images/construction-dumpsters-pickup.jpg', desc: 'Debris removal, demo waste, and large renovation cleanups for contractors and builders.' },
    { title: 'Commercial', img: '/images/commercial-waste-disposal.jpg', desc: 'Ongoing commercial waste needs, job-site cleanups, and business waste disposal solutions.' },
  ];
